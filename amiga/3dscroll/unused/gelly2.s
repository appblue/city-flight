...
;
	...
	move.b	#'A',d0
	lea	Zeros+64*2*32+0*2*16,a0
	jsr	putCh
	move.b	#'a',d0
	lea	Zeros+64*2*32+1*2*16,a0
	jsr	putCh
	move.b	#'.',d0
	lea	Zeros+64*2*32+2*2*16,a0
	jsr	putCh
	move.b	#'a',d0
	lea	Zeros+64*2*32+3*2*16,a0
	jsr	putCh
...
;	jsr	putCh
	move.b	#'E',d0
	lea	Zeros+64*2*16,a0
;	jsr	putCh
	move.b	#'F',d0
	lea	Zeros+1*2*16+64*2*8*3,a0
;	jsr	putCh
	move.b	#'G',d0
	lea	Zeros+2*2*16+64*2*8*3,a0
;	jsr	putCh
	move.b	#'H',d0
	lea	Zeros+3*2*16+64*2*8*3,a0
;	jsr	putCh
