...
f = open("c:\\users\\pejdys\\desktop\\harddrive\\sources\\1scp\\zx.bin","wb")
for z in range(0,LL_Z):
    for x in range(0,LL_X):
        xx = tab_xz[x,z]
...
for z in range(0,LL_Z):
    f = open("c:\\users\\pejdys\\desktop\\harddrive\\sources\\1scp\\4bit\\lines_bsets_4bit_%02d_v3.bin"%z,"wb")
...
f = open("c:\\users\\pejdys\\desktop\\harddrive\\sources\\1scp\\lens.bin","wb")
